...
public class BinarySearchTree {
  ...
  // Ağaç'ta sağ yaprak boş olmayana kadar gidersek, ulaştığımız en sağdaki yaprak
  // en büyük sayımızdır.
  Dugum Max() {
    Dugum sonuc = kok;
  ...
  // Ağaç'ta sol yaprak boş olmayana kadar gidersek, ulaştığımız en soldaki yaprak
  // en küçük sayımızdır.
  Dugum Min() {
    Dugum sonuc = kok;
  ...
  // Eğer sayımız root'dan(kök) başlayıp tüm alanlara baka baka büyükse sağa
  // değilse sola doğru kaydırıyoruz.
  ...
  // Eğer sağ taraf boş değilse en sağına kadar gidip en küçüğünü alıp y'ye
  // eşitliyoruz.
  // Bu şekilde yaptıktan sonra bulduğumuz yeri istediğimiz/aradığımız sayının
  // üstüne yazarak onu silmiş/kaldırmış oluyoruz.
